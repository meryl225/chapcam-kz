      ...
      <main className="relative mx-auto max-w-[760px] px-4 pb-28 sm:px-6 lg:max-w-7xl lg:max-w-[1440px] lg:pb-12">
        <header className="flex h-[76px] items-center justify-between gap-4 border-b border-[#d8e8f6]/80">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button type="button" onClick={() => setPlansOpen(true)} className="rounded-xl border border-[#168bd1] bg-[#138bd1] px-2.5 py-2 text-[11px] font-bold text-white shadow-[0_6px_18px_-10px_rgba(19,139,209,.75)] transition hover:-translate-y-0.5 hover:border-[#0874b8] hover:bg-[#0874b8] sm:px-3 sm:text-[13px]">Tarifs</button>

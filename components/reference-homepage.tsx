...
const tools = [
  ...
  { title: "Photos en vidéo", description: "Anime tes photos en quelques secondes.", image: "/swap/poster-photo-video.png", icon: Camera, color: "#10b981", href: "/dashboard/photo-video" },
  { title: "Motion Control", description: "Pilote les mouvements par IA.", image: "/swap/poster-motion.png", icon: Sparkles, color: "#6366f1", href: "/dashboard/motion" },
  { title: "Message Vocal", description: "Crée des voix réalistes.", image: "/swap/poster-message-vocal.png", icon: Menu, color: "#ec4899", href: "/dashboard/message-vocal" },
  { title: "Traduction vidéo", description: "Double tes vidéos dans ta langue.", image: "/swap/poster-video-translation.png", icon: Music2, color: "#14b8a6", href: "/dashboard/video-translation" },

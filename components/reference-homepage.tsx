      ...
      <main className="relative mx-auto max-w-[760px] px-4 pb-28 sm:px-6 lg:max-w-7xl lg:max-w-[1440px] lg:pb-12">
        ...
        <section className="relative overflow-hidden rounded-[1.7rem] border border-white/90 bg-[#dceeff] shadow-[0_24px_60px_-28px_rgba(37,99,235,.55)] lg:min-h-[500px]">
          <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_28%,rgba(255,255,255,.65),transparent_25%),radial-gradient(circle_at_72%_20%,rgba(125,211,252,.34),transparent_30%),radial-gradient(circle_at_92%_90%,rgba(139,92,246,.22),transparent_34%)]" />
            <span className="absolute -left-10 top-12 text-[11rem] font-light leading-none tracking-[-.18em] text-white/25 blur-[.3px] sm:-left-5 sm:text-[15rem] lg:-left-16 lg:top-20 lg:text-[21rem]">∞</span>
            <span className="absolute right-[34%] top-[-4rem] text-[9rem] font-light leading-none tracking-[-.18em] text-[#8b5cf6]/10 sm:text-[13rem] lg:right-[38%] lg:top-[-7rem] lg:text-[18rem]">∞</span>
            <span className="absolute -bottom-16 left-[30%] hidden text-[14rem] font-light leading-none tracking-[-.18em] text-white/20 lg:block">∞</span>
            <span className="absolute -bottom-10 right-[-2rem] text-[9rem] font-light leading-none tracking-[-.18em] text-[#7dd3fc]/20 sm:text-[13rem] lg:-right-10 lg:text-[19rem]">∞</span>
            <div className="absolute left-[8%] top-[18%] h-px w-28 bg-gradient-to-r from-transparent via-white/70 to-transparent sm:w-44 lg:left-[18%] lg:w-64" />
            <div className="absolute bottom-[17%] right-[28%] h-px w-24 rotate-[-18deg] bg-gradient-to-r from-transparent via-[#8b5cf6]/25 to-transparent sm:w-40 lg:w-56" />
            <div className="absolute left-[13%] top-[24%] size-1 rounded-full bg-white/80 shadow-[0_0_12px_4px_rgba(255,255,255,.45)] sm:left-[24%]" />
            <div className="absolute bottom-[24%] left-[42%] size-1 rounded-full bg-[#8b5cf6]/50 shadow-[0_0_12px_4px_rgba(139,92,246,.25)]" />
            <div className="absolute right-[31%] top-[33%] size-1 rounded-full bg-white/70 shadow-[0_0_10px_3px_rgba(255,255,255,.4)]" />
          </div>

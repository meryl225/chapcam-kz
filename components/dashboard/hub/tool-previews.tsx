  ...
  return (
    <div className="flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-black/30 p-3">
      ...
      <div className="flex flex-col items-center gap-1">
        <div className="cc-flow h-0.5 w-8 rounded-full bg-gradient-to-r from-transparent via-[#00ff88] to-transparent" />
        <span className="text-[9px] font-bold text-[#00ff88]">IA</span>
        <div className="cc-flow h-0.5 w-8 rounded-full bg-gradient-to-r from-transparent via-[#00ff88] to-transparent" />
      </div>

      <div className="relative h-20 w-20 overflow-hidden rounded-lg ring-2 ring-[#00ff88]/50">
        <Image
          ...
          className="object-cover"
        />
        <span className="absolute bottom-0 left-0 right-0 bg-[#00ff88]/80 py-0.5 text-center text-[9px] font-semibold text-black">
          ChapCam
        </span>
      </div>
    </div>
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-black/30 p-3">
      ...
      <div className="flex items-center justify-center gap-2 text-[11px] font-semibold">
        <span className="rounded bg-white/10 px-2 py-0.5 text-gray-300">Hello</span>

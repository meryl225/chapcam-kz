...
function SidebarContent({
  ...
  <span className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[#0a1024] ring-1 ring-emerald-300/35"><img src="/images/jetons-logo.png" alt="Logo Jetons" className="h-full w-full scale-[1.3] object-cover object-center" /></span>

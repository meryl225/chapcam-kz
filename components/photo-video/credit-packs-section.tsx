...
import { Check, Loader2, Clapperboard, ArrowRight } from 'lucide-react'
...
// Section d'achat de credits Studio Photo en Video, achetables SANS forfait
// Live Swap. Reutilise le tunnel de paiement partage (PayDunya / crypto).
  ...
  return (
    <section className="mt-6 rounded-2xl border border-hairline bg-card p-5 lg:p-6">
      ...
      <div className="mb-1 flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-foreground">Acheter des vidéos</h2>
      </div>
      <p className="mb-5 text-sm text-muted-foreground text-pretty">
        Pas de forfait Live Swap ? Achète directement des crédits vidéo. 1 crédit = 1 vidéo de 30
        secondes. Paiement sécurisé par mobile money, carte ou crypto.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="mt-2 flex items-baseline gap-1">
                ...
                <span className="text-sm text-muted-foreground">vidéos de 30s</span>
              </div>

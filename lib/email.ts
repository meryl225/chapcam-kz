...
// Template email : livraison de la licence ChapCam PC + lien de telechargement
export async function sendPcLicenseEmail(
  ...
  try {
    const { data, error } = await client.emails.send({
      from: FROM_EMAIL,
      to: [to],
      subject: 'ChapCam PC - Votre cle de licence et votre telechargement',
      html: `
        <!DOCTYPE html>
        <html>
        <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
        <body style="margin:0;padding:0;background-color:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;padding:40px 20px;">
            ...
            <tr><td style="background:linear-gradient(135deg,#1a1a1a 0%,#0d0d0d 100%);border-radius:16px;padding:40px;border:1px solid #222;">
              ...
              <h1 style="color:#00ff88;margin:0 0 20px 0;font-size:24px;text-align:center;">ChapCam PC est a vous !</h1>
              <p style="color:#ffffff;font-size:16px;line-height:1.6;margin:0 0 20px 0;">Bonjour <strong>${userName}</strong>,</p>
              <p style="color:#cccccc;font-size:16px;line-height:1.6;margin:0 0 20px 0;">
                Merci pour votre achat ! Voici votre cle de licence personnelle. Conservez-la precieusement :
                vous en aurez besoin lors de la premiere ouverture du logiciel sur votre PC.
              </p>

              <div style="background:#111111;border-radius:12px;padding:20px;margin:20px 0;border:1px solid #00ff8855;text-align:center;">
                <p style="color:#888;font-size:12px;text-transform:uppercase;letter-spacing:1px;margin:0 0 10px 0;">Votre cle de licence</p>
                <p style="color:#00ff88;font-size:22px;font-weight:bold;font-family:monospace;letter-spacing:2px;margin:0;">${licenseKey}</p>
              </div>

              <div style="background:#111111;border-radius:12px;padding:20px;margin:20px 0;border:1px solid #333;">
                <table width="100%" cellspacing="0" cellpadding="8">
                  <tr><td style="color:#888;font-size:14px;border-bottom:1px solid #222;">Produit</td><td style="color:#fff;font-size:14px;text-align:right;border-bottom:1px solid #222;font-weight:bold;">ChapCam PC (a vie)</td></tr>
                  <tr><td style="color:#888;font-size:14px;">Montant</td><td style="color:#00ff88;font-size:14px;text-align:right;font-weight:bold;">${amount.toLocaleString()} FCFA</td></tr>
                </table>
              </div>

              <div style="text-align:center;margin-top:30px;">
                <a href="${downloadUrl}" style="display:inline-block;background:#00ff88;color:#000;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:bold;font-size:16px;">Telecharger ChapCam PC</a>
              </div>

              <div style="background:#00ff8810;border-radius:12px;padding:16px;margin-top:24px;">
                <p style="color:#00ff88;font-size:13px;margin:0 0 8px 0;font-weight:bold;">Comment l'installer :</p>
                <ol style="color:#cccccc;font-size:13px;line-height:1.7;margin:0;padding-left:18px;">
                  <li>Telechargez et installez ChapCam.exe sur votre PC.</li>
                  <li>Lancez le logiciel et collez votre cle de licence.</li>
                  <li>Choisissez votre visage et activez la camera virtuelle.</li>
                </ol>
              </div>
            </td></tr>
            <tr><td style="text-align:center;padding-top:30px;">
              <p style="color:#666;font-size:12px;margin:0 0 10px 0;">Besoin d'aide ? WhatsApp : +225 05 55 56 01 89</p>
              <p style="color:#666;font-size:12px;margin:0;">ChapCam - Face Swap en Temps Reel<br><a href="https://chapcam.com" style="color:#00ff88;text-decoration:none;">chapcam.com</a></p>
            </td></tr>
          </table>
        </body>
